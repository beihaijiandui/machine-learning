...
KNN::KNN(int k,double data[12][2],char label[12]):k(k)
{
    for(int i=0;i<12;i++)
    for(int j=0;j<2;j++)
...
void KNN::get_max_freq_label()
{
    ...
    printf("\n");
    printf("the test data belongs to the %c label\n",labelofmax);
}
